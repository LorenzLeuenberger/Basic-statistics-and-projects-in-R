...
From @tbl-characteristics we can see that there were 4'829 boys and 5'201 girls participating in the study. The median age was 7.9 years for boys and 8.4 years for girls. The median height was 131 cm for boys and 132 cm for girls. The median weight was 27 kg for boys and 28 kg for girls.

## Body height in boys and girls
### Descriptive statistics

@fig-height shows the body height of the children grouped by age.
...
From @fig-height we can see that the height and weight increases with age. Therefore, i construct age groups with 2 yearly steps and then look at the mean height and weight in these groups.

```{r}
#| warning: false
#| label: tbl-height
#| tbl-cap: Body height by age groups and sex
...
The low p-values resulting from the Shapiro-Wilk test suggest that the height in these to groups does nto follow a normal distribution. Because the sample size in this age group is high for both boys and girls (see @tbl-height), I will not exclude the age group [0,2). I will not perform a transformation of the height to ensure comparability accross the different age groups.
